...
int main(){
    srand(time(0));
    short chchoic,wpchoic,hmchoic,rolldie,dodge,kill,lifepts;
    unsigned int ans,ans1,ans2,ans3,ans4,ans5,ans6,ans7,begTime,endTime,totTime,wake=1,guess=1;
    string name,message,roll,mssgans;
    char ans10;
